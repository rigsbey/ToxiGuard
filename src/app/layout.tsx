  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="me" href="https://twitter.com/toxiguard" />
        <link rel="me" href="https://www.linkedin.com/company/toxiguard" />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "sameAs": [
                ...
                "https://www.linkedin.com/company/toxiguard"
              ]
            })
          }}
        />
      ...
      <body className={inter.className}>
        {/* Google Tag Manager – lazy load to avoid render-blocking */}
